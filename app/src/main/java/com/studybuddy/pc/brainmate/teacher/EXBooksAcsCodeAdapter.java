...
public class EXBooksAcsCodeAdapter extends BaseAdapter {

    // Declare Variables
    String temp_url;
    Expired_book mContext;
    ...
    public EXBooksAcsCodeAdapter(Expired_book context, ArrayList<HashMap<String, String>> BooksArray) {
        mContext = context;
    ...
    public View getView(final int position, View view, ViewGroup parent) {
        ...
        if (view == null) {
            ...
            view = inflater.inflate(R.layout.expridebbooks, null);
        ...
        Image_url = "http://techive.in/studybuddy/publisher/" + Image_Name;
