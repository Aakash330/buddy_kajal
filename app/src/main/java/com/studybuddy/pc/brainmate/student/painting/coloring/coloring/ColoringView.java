...
import com.studybuddy.pc.brainmate.student.painting.algorithm.FloodFill;
import com.studybuddy.pc.brainmate.student.painting.util.Vector2D;
...
public class ColoringView extends View {
    ...
    private void color(Vector2D p) {
        ...
        ColoringActivity coloringActivity = new ColoringActivity();

        SharedPreferences prefs = PreferenceManager.getDefaultSharedPreferences(getContext());
        String coco = prefs.getString("selectedColor", "-8355712");
        int color = Integer.parseInt(coco);
        Log.d("coco123", coco);
        // int  color = prefs.getInt("selectedColor",0);
        //
        //Log.d("Coloclcoclco", "STR2 "+String.valueOf(color));
