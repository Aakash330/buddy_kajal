...
public class ConfiOjectiveAdapter extends BaseAdapter {
    String code;
    // Declare Variables
...
*/
    ...
    public ConfiOjectiveAdapter(PaperConfirmition studentdashBord, ArrayList<HashMap<String, String>> booksname) {
...
//            Log.d("BooksCode",code);
        if (view == null) {
            ...
            view = inflater.inflate(R.layout.confiobjetivequelist, null);
