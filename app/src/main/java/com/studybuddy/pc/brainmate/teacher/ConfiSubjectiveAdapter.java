...
public class ConfiSubjectiveAdapter extends BaseAdapter {
    ...
    public ConfiSubjectiveAdapter(PaperConfirmition studentdashBord, ArrayList<HashMap<String, String>> booksname) {
    ...
    public View getView(final int position, View view, ViewGroup parent) {
        ...
        if (view == null) {
            ...
            view = inflater.inflate(R.layout.confistudentdashlist, null);
