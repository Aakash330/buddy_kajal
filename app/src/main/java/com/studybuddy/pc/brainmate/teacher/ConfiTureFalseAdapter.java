...
public class ConfiTureFalseAdapter extends BaseAdapter {
...
*/
    ...
    public ConfiTureFalseAdapter(PaperConfirmition studentdashBord, ArrayList<HashMap<String, String>> booksname) {
    ...
    public View getView(final int position, View view, ViewGroup parent) {
        ...
        if (view == null) {
            ...
            view = inflater.inflate(R.layout.confitruefalselist, null);
