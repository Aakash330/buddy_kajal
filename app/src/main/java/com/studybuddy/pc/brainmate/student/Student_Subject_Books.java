...
/*
public class Student_Subject_Books extends AppCompatActivity {
...
/*Note Not in use*//*
    ...
    ListView list;
    StudentBooksdetailsAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle("Books");
        setContentView(R.layout.activity_student__subject__books);
        ...
        adapter = new StudentBooksdetailsAdapter(Student_Subject_Books.this, Arraylist);
        list.setAdapter(adapter);
        progressDialog = new ProgressDialog(Student_Subject_Books.this);
        progressDialog.setMessage("Loading..."); // Setting Title
        progressDialog.setProgressStyle(ProgressDialog.STYLE_SPINNER); // Progress Dialog Style Spinner
        progressDialog.show(); // Display Progress Dialog
        progressDialog.setCancelable(false);
        RequestQueue queue = Volley.newRequestQueue(Student_Subject_Books.this);
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
...

                        {
                           ...
                           */
/* adapter = new BooksdetailsAdapter(Books_Details.this, searchResults,UpcomigID);
                            list.setAdapter(adapter);*//*
...
/* return builder.create();*//*
    ...
    public class StudentBooksdetailsAdapter extends BaseAdapter {

        // Declare Variables

        Student_Subject_Books mContext;
        ...
        public StudentBooksdetailsAdapter(Student_Subject_Books context, ArrayList<HashMap<String, String>> animalNamesList) {
            mContext = context;
